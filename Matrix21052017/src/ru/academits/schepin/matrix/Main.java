...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Vector z3 = new Vector(2);
        z3.setByIndex(0,2.5);
        z3.setByIndex(1,2.1);
        System.out.println("Вектор z3= " + z3);

        Vector z4 = new Vector(2);
        z4.setByIndex(0,2.5);
        z4.setByIndex(1,2.1);
        ...
        System.out.println("Прибавление матрицы g1 к g");
        System.out.println("Матрица g1= " + g1);
        System.out.println("Матрица g= " + g);
        g.add(g1);
        System.out.println("Матрица g= " + g);
        ...
        System.out.println( "Определитель матрицы m = " + m.determinant());
        System.out.println();

        System.out.println("Умножение матрицы m на скаляр:");
        System.out.println("m= " + m);
